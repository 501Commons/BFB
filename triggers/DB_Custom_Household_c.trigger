trigger DB_Custom_Household_c on npo02__Household__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_Household_c' );
	}
}